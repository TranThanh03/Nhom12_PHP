                ...
                <div class="icon-account">
                    ...
                    <?php else:?>
                        <div class="account-info">
                            ...
                            <ul id="slidebar">
                                <li><a href="index.php?controller=user&action=detail">Thông tin khách hàng</a></li>
                                <li><a href="index.php?controller=user&action=logout" style="color: red;">Đăng xuất</a></li>
                            </ul>
                        </div>
                    <?php endif;?>
                </div>
